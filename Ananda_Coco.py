...
class DefectDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        label = 0
        for ann in anns:
            mask += self.coco.annToMask(ann)  # Add up all masks for the image
            if ann['category_id'] == 1:  # Assuming 1 is the defect category ID
                label = 1
...
# Datasets
train_dataset = DefectDataset(coco_json_path, train_image_dir, transform=transform)
test_dataset = DefectDataset(coco_json_path, train_image_dir, transform=transform)
